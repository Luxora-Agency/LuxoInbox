class Internal::ReconcilePlanConfigService
  def perform
    # Fork keeps premium config editable: clear any stale warning and skip the
    # community reset/reconcile so super-admin edits persist and no upsell banner fires.

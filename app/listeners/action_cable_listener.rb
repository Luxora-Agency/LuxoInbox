class ActionCableListener < BaseListener
  ...
  def typing_event_listener_tokens(account, conversation, user)
    ...
    (conversation_user_tokens(account, conversation) + [conversation.contact_inbox.pubsub_token]) - [current_user_token]
  end
  ...
  def conversation_user_tokens(account, conversation)
    ...
    tokens += conversation.conversation_participants.includes(:user).map do |participant|

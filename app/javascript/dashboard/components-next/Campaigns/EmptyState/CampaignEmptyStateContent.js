export const ONGOING_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    trigger_rules: {
      url: 'https://luxoinbox.com/features/chatbot/',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://luxoinbox.com/pricing',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    message: 'Hi! LuxoInbox here. Need help setting up? Let me know!',
    campaign_status: 'active',
    enabled: false,
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://{*.}?luxoinbox.com/apps/account/*/settings/inboxes/new/',
      time_on_page: 10,
    },
    trigger_only_during_business_hours: false,
...
export const ONE_OFF_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    message:
      'Hello! Enjoying our product? Share your feedback with us — it only takes a minute.',
    campaign_status: 'active',
    enabled: true,

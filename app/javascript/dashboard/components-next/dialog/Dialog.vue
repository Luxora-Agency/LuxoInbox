    ...
    >
      <OnClickOutside @trigger="close">
        <form
          ...
          class="flex flex-col w-full h-auto gap-6 p-6 overflow-visible text-start align-middle transition-all duration-300 ease-in-out transform bg-n-alpha-3 backdrop-blur-[100px] shadow-2xl shadow-n-slate-12/10 rounded-2xl ring-1 ring-n-weak/50"

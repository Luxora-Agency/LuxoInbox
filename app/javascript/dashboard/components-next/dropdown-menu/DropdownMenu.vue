...
<template>
  <div
    class="bg-n-alpha-3 backdrop-blur-[100px] border-0 ring-1 ring-n-weak/50 absolute rounded-2xl z-50 flex flex-col min-w-[136px] shadow-xl shadow-n-slate-12/5 pt-2 overflow-hidden"
  >

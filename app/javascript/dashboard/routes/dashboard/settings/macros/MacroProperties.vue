  ...
  >
    ...
    <div class="mt-2">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
        <button
          class="p-2 relative rounded-lg border border-solid justify-between items-start gap-2 flex flex-col text-start cursor-default"
      ...
      <div
        class="mt-2 flex items-start p-2 bg-n-alpha-1 gap-2 dark:bg-n-solid-3 rounded-lg"
      >
        <Icon
          icon="i-lucide-info"

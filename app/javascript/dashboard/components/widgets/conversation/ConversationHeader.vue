...
import ConversationScreenshotButton from 'dashboard/components-next/messengerSimulator/ConversationScreenshotButton.vue';
...
<template>
  ...
  >
    ...
    >
      ...
      <ConversationScreenshotButton :conversation-id="currentChat.id" />
